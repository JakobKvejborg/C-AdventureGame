...
internal class MonsterContainer
{
    ...
    public void AddMonstersToList()
    {
        ...
        Monster normalGoblin = new("Goblin", 10, 10, 0, 1, 2, 6, 1, normalGoblinImage);
        Monster normalOrc = new("Orc", 7, 7, 0, 0, 3, 9, 0, normalOrcImage);
        Monster normalSkeleton = new("Skeleton", 8, 8, 1, 0, 1, 7, 0, normalSkeletonImage);
        Monster normalGhast = new("Ghast", 7, 7, 0, 0, 4, 8, 1, normalGhastImage);
        Monster normalCorpse = new("Corpse", 8, 4, 0, 0, 2, 5, 0, normalCorpseImage);
        Monster normalDemon = new("Demon", 10, 10, 0, 0, 3, 10, 2, normalDemonImage);
        Monster normalGhost = new("Ghost", 8, 8, 0, 0, 3, 10, 0, normalGhostImage);

        // List of noprefix monsters
        Monster golem = new("Golem", 23, 23, 2, 0, 3, 15, 0, golemImage);
        Monster knight = new("Knight", 19, 19, 1, 0, 7, 17, 2, knightImage);
        Monster horror = new("Horror", 20, 20, 3, 0, 3, 13, 0, horrorImage);
        ...
        Monster deadTroll = new("Dead Troll", 16, 16, 3, 0, 4, 20, 2, deadTrollImage);

        // Special enemies
        Monster act1Boss = new("Aldrus Thornfell", 82, 82, 5, 0, 7, 40, 5, act1BossImage); // Act1 boss
        Monster hungryBeast = new("Hungry Beast", 36, 36, 3, 0, 9, 30, 0, hungryBeastImage);
        Monster act2Boss = new("Wintermaw", 240, 240, 8, 0, 20, 50, 0, act2BossImage);
        Monster act3Boss = new("The Devouring Abyss", 400, 400, 19, 0, 30, 100, 30, null);

        // Act 2 Snow Monsters
        Monster snowGoldGoblin = new("Gold Goblin", 30, 30, 6, 0, 9, 0, 9, snowGoblinImage);
        ...
        Monster seaGhost = new("Ghost of the Sea", 110, 110, 0, 0, 27, 30, 17, seaGhostImage);
        Monster seaMonster = new("Monster of the Sea", 115, 115, 25, 0, 0, 38, 20, seaMonsterImage);
        ...
        // Act 4 Dragons east
        Monster casterDragon = new("Caster Dragon", 220, 220, 33, 0, 0, 90, 30, casterDragonImage);
        Monster dragonKing = new("Dragon King", 300, 300, 20, 0, 0, 100, 30, dragonKingImage);
        Monster dragonHydra = new("Dragon Hydra", 266, 266, 33, 0, 0, 79, 30, dragonHydraImage);
        Monster silverDragon = new("Silver Dragon", 250, 250, 60, 0, 0, 20, 30, silverDragonImage);
