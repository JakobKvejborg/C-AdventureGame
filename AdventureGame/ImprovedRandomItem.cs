...
public class ImprovedRandomItem : Item
{
    ...
    private static readonly List<string> PrefixesEpicUniqueLegendary = new() { "Ancient", "Cursed", "Enchanted", "Fabled", "Mystic", "Worn", "Epic", "Golden", "Strong", "Mythical" };
    ...
    public ImprovedItemQuality Quality { get; private set; }
    ...
    {
        (ImprovedItemQuality.Damaged, 30),    // the number represents % chance droprate
        (ImprovedItemQuality.Normal, 53),   
        (ImprovedItemQuality.Magic, 7),     
        (ImprovedItemQuality.Strong, 4.9),   
        (ImprovedItemQuality.Rare, 2),     
        (ImprovedItemQuality.Unique, 2),     
        (ImprovedItemQuality.Epic, 1),
        (ImprovedItemQuality.Legendary, 0.1), 
    };
    ...
    private string GenerateRandomName(ItemType itemType, ImprovedItemQuality quality)
    {
    ...
    private void AssignStatsBasedOnTypeAndQuality(ItemType itemType, ImprovedItemQuality quality)
    {
        ...
        switch (itemType)
        {
            case ItemType.WeaponRightHand:
                ...
                LevelRequirement = (int)(_random.Next(1, 5) + multiplier - 1);
                break;

            case ItemType.Armor:
                Strength = (int)(_random.Next(0, 5) * multiplier);
                Health = (int)(_random.Next(2, 15) * multiplier);
                Armor = (int)(_random.Next(1, 2) * multiplier);
                LevelRequirement = (int)(_random.Next(1, 3) + multiplier - 1);
                break;
            ...
            case ItemType.Gloves:
                ...
                LevelRequirement = (int)(_random.Next(1, 4) + multiplier - 1);
                break;

            case ItemType.Boots:
                DodgeChance = (int)(_random.Next(0, 9) * multiplier);
                Armor = (int)(_random.Next(0, 3) * multiplier + multiplier - 1);
                Health = (int)(_random.Next(1, 3) * (multiplier + multiplier) + multiplier);
                LevelRequirement = (int)(_random.Next(1, 5) + multiplier - 1);
                break;
            ...
            case ItemType.Belt:
                ...
                LevelRequirement = (int)(_random.Next(1, 6) + multiplier - 1);
                break;
            ...
            case ItemType.Leggings:
                ...
                Health = (int)(_random.Next(0, 10) * (multiplier * multiplier + multiplier - 1));
                StrengthRequirement = (int)(_random.Next(1, 6) * multiplier);
                LevelRequirement = (int)(_random.Next(1, 5) + multiplier - 1);
                break;
            ...
            case ItemType.Helmet:
                ...
                StrengthRequirement = (int)(_random.Next(1, 6) * multiplier);
                LevelRequirement = (int)(_random.Next(1, 7) + multiplier - 1);
                break;

            case ItemType.WeaponLeftHand:
                Strength = (int)(_random.Next(0, 2) * multiplier);
                Regeneration = (int)(_random.Next(0, 3) * multiplier * multiplier);
                Lifesteal = (int)(_random.Next(0, 5) * multiplier);
                CritDamage = (int)(_random.Next(0, 1) + (multiplier - 1) * multiplier);
                StrengthRequirement = (int)(_random.Next(1, 2) * multiplier);
                LevelRequirement = (int)(_random.Next(4, 16) + multiplier - 1);
                break;

            case ItemType.Shoulders:
                Regeneration = (int)(_random.Next(0, 2) * multiplier * multiplier);
                Health = (int)(_random.Next(0, 12) * (multiplier + multiplier));
                Armor = (int)(_random.Next(1, 3) * multiplier);
                LevelRequirement = (int)(_random.Next(2, 8) + multiplier - 1);
                break;
                ...
                LevelRequirement = (int)(_random.Next(10, 16) + multiplier - 1);
                break;
