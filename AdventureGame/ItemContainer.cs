...
public class ItemContainer
{
    ...
    public void AddItemsToList()
    {
        ...
        Item item1b = new("Rusty Armor", ItemType.Armor, 1, 0, 1, 0, 2, 1);
        Item item2b = new("Cloak", ItemType.Armor, 0, 5, 2, 0, 2, 3);
        Item item3b = new("Rags", ItemType.Armor, 5, 0, 0, 0, 0, 2);
        Item item4b = new("Boots", ItemType.Boots, 0, 0, 1, 0, 0, 2);
        Item item5b = new("Sandals", ItemType.Boots, 0, 8, 0, 0, 0, 2);
